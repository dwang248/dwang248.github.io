...
To view the results, we require the function 'tidy' from the broom package. This function will allow use to view the estimates for each of the independent variables as well as the constant of our regression. 
...
On average, holding everything else constant, a one cent increase in residential electricity will increase the price of Bitcoin by .3484%.
