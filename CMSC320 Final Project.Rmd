...
There are several limitations in using linear methods for classification. That is
...
Using the function 'importance', we are able measure the variable importance from the random forest.
